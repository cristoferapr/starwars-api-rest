...
Revision ID: 9d9bc5f78411
Revises: efe0db66c22c
Create Date: 2023-04-17 23:12:24.856641
...
revision = '9d9bc5f78411'
down_revision = 'efe0db66c22c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('homeworld_planet_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['homeworld_planet_id'], ['planets.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
